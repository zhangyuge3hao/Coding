...
public class ArrayListExamples动态数组 {
	public static void main(String[] args) {
        ...
        // 检查元素的位置
        int pos = list.indexOf("Item5");
        System.out.println("元素 Item2 在哪一位: " + pos);//返回-1表示不存在
        ...
        // 检查数组链表中是否包含某元素
        String sa = "Item1";
        boolean element = list.contains(sa);
        System.out.println("检查数组链表中是否包含某元素--Item1: "+ element);
        ...
        System.out.println("移除第一次找到的 \"Item3\"元素: " + list);//自动紧缩
